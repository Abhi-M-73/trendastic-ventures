...
import { getAllDeposits, approveDeposit, rejectDeposit } from '../../../api/admin.api';
          ...
          <button
            onClick={async () => {
              ...
              try {
                ...
                await approveDeposit(rowData._id);
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          <button
            onClick={async () => {
              ...
              try {
                setActionLoading(rowData._id);
                await rejectDeposit(rowData._id, reason.trim());
