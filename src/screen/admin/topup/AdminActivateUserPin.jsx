...
import { activateUserPinByAdmin, getUserByUsername, pinTopupUser, topupUser } from '../../../api/admin.api';
import ReusableForm from '../../../components/ui/ReusableForm';
import ReusableButton from '../../../components/ui/ReusableButton';
import toast from 'react-hot-toast';

const AdminActivateUserPin = () => {
    ...
    const { mutate, isPending } = useMutation({
      mutationFn: activateUserPinByAdmin,
        onSuccess: (res) => {
            toast.success(res?.message || 'Pin activated successfully');
            queryClient.invalidateQueries({ queryKey: ['pinActivationHistory'] });
            setPinType("");
        },
        onError: (error) => {
    ...
    const handleTopupUser = () => {
        ...
        mutate({ username: user?.username, pinType});
    };
...
export default AdminActivateUserPin;